<x-app-layout meta-title="Taysoft Blog"
    ...
    <div class="container max-w-4xl mx-auto py-6">
                        ...
                        <div class="col-span-3">
                            ...
                            <div class="flex gap-4 mb-2">
                                @foreach($post->categories as $category)
                                    <a href="#" class="bg-yellow-500 text-white p-1 rounded text-xs font-bold uppercase">
                                        {{$category->title}}
                                    </a>
                                @endforeach
                            </div>
                            ...
                            <a href="{{route('view', $post)}}" class="text-xs uppercase text-gray-700 hover:text-gray-900">Devamını Oku <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        @foreach($categories as $category)
            <div>
                <h2 class="text-lg sm:text-xl font-bold text-purple-500 uppercase pb-1 border-b-2 border-purple-500 mb-3">
